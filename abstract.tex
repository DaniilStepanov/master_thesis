...
\abstractcontent{
Одной из основых проблем методов обеспечения качества программного обеспечения является локализация найденных в нем ошибок. Этот процесс в настоящее производится вручную, что зачастую приводит к большим временным затратам. В данной работе был предложен подход к решению данной проблемы --- метод автоматической программной редукции.

Метод разрабатывался для одного из популярных языков программирования Kotlin. Основой предложенного метода является комбинирование существующих технологий программной редукции и специфичных трансформаций для целевого языка программирования над различными видами представления программы. В работе представлено описание всех применяемых технологий и трансформаций, которые запускаются в определенном порядке до того момента, как тестовый пример, приводящий к программному сбою, не перестанет изменяться. 
